 ...
 * 
 * Class of Test
 * Creation of tow {@link person.Person} with invented informations.
 * We test on the both that the {@link person.Person#Person(short, String)} constructor well function and fill correct informations.
 *
 */
